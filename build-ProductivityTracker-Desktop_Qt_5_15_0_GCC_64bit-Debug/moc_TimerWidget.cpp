...
#include <memory>
#include "../ProductivityTracker/TimerWidget.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_TimerWidget_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_TimerWidget_t qt_meta_stringdata_TimerWidget = {
    {
QT_MOC_LITERAL(0, 0, 11) // "TimerWidget"
...
QT_INIT_METAOBJECT const QMetaObject TimerWidget::staticMetaObject = { {
    QMetaObject::SuperData::link<QMainWindow::staticMetaObject>(),
    qt_meta_stringdata_TimerWidget.data,
    qt_meta_data_TimerWidget,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *TimerWidget::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_TimerWidget.stringdata0))
