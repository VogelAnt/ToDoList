...
#include <memory>
#include "../ProductivityTracker/MainMenu.h"
...
QT_MOC_LITERAL(1, 9, 13), // "InitializeTab"
QT_MOC_LITERAL(2, 23, 0) // ""

    },
    "MainMenu\0InitializeTab\0"
};
...
void MainMenu::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MainMenu::InitializeTab)) {
                *result = 0;
                return;
            }
        }
